...
import { CATEGORIES_ROUTE, CHANGEPASSWORD_ROUTE, LOGIN_ROUTE, MENU_ITEMS_ROUTE, NOTIFICATION_ROUTE, ORDERS_ROUTE, PROFILE_ROUTE, REGISTER_ROUTE, USERS_ROUTE } from '@/constant/routesApp';

export default function MenuMobile({ isAdmin, status, onClose }) {
    const path = usePathname();
    return (
        <div className='fixed bottom-0 left-0 z-30 w-full bg-white top-16'>
