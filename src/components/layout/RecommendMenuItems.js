  ...
  return (
    <section id="recommendations" className="mt-3 mb-8 md:mb-12" ref={(el) => {
      ...
      <div className="mb-4 text-center">
        {loadingRecommend ? <SkeletonLoadingSectionHeader hasImage={false} /> : <SectionHeader subHeader={"check out"} mainHeader={t("Bạn sẽ thích")} hasLine={hasLine} classNameTitle={classNameTitle} />}
      </div>
