...
export default function ValidatedSelectInput({ label, name, error, inputRef, options = [], ...props }) {
  return (
    <div className="flex flex-col gap-1">
      ...
      <div className="relative">
        <select
          ref={inputRef}
          className={`w-full py-3 pl-5 pr-8 border rounded-md outline-none appearance-none bg-white ${
