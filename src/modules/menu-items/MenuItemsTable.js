                                ...
                                <tr className="transition-colors hover:bg-surface-container-low group" key={item._id}>
                                    ...
                                    <td className="sticky right-0 z-10 px-6 py-4 text-right bg-white ">
                                        <div className="flex justify-end gap-3">
                                            <Link href={`${MENU_ITEM_EDIT_ROUTE}/${item._id}`} className={`transition-colors text-secondary hover:text-primary ${loadingForm ? "opacity-50 cursor-not-allowed" : ""}`}><MdOutlineModeEdit className="w-5 h-5" title='Chỉnh sửa' /></Link>
