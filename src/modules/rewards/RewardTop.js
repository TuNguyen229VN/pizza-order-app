            ...
            <div className='p-8 mt-4 bg-primary rounded-2xl'>
                ...
                <div className='flex flex-col gap-4 mt-4 md:flex-row'>
                    <div className='w-full md:h-[160px] relative bg-white p-4 rounded-lg '>
                        <p className='mb-4 text-xl font-medium capitalize text-primary'>{rTrans("Tạo tài khoản")}</p>
                        <p>{rTrans("Sử dụng website hoặc ứng dụng để đăng ký dễ dàng")}.</p>
                        <p className='absolute font-semibold -bottom-3 right-2 text-7xl text-primary'>1</p>
                    </div>
                    <div className='w-full md:h-[160px] relative bg-white p-4 rounded-lg'>
                        <p className='mb-4 text-xl font-medium capitalize text-primary'>{rTrans("Tích điểm")}</p>
                        <p>10.000đ = 1 {rTrans("điểm")}</p>
                        <p className='absolute font-semibold -bottom-3 right-2 text-7xl text-primary'>2</p>
                    </div>
                    <div className='w-full md:h-[160px] relative bg-white p-4 rounded-lg'>
                        <p className='mb-4 text-xl font-medium capitalize text-primary'>{rTrans("Giảm giá")}</p>
                        <p>{rTrans("Giảm giá tổng đơn hàng theo mức độ thân thiết khách hàng")}.</p>
