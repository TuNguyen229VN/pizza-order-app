...
.pp-tab{flex:1;display:flex;align-items:center;justify-content:center;gap:6px;padding:13px 8px;background:none;border:none;cursor:pointer;font-size:13px;font-weight:700;color:#999;border-bottom:3px solid transparent;margin-bottom:-2px;transition:all .2s;font-family:inherit}
...
.pp-lbl{font-size:13px;font-weight:700;color:#333;display:block}
...
.pp-clr{background:none;border:none;cursor:pointer;padding:0 14px;color:#bbb;font-size:13px;transition:color .2s}
...
.pp-drop-txt{font-size:13px;color:#333;line-height:1.4}
.pp-empty{position:absolute;top:calc(100% + 6px);left:0;right:0;background:#fff;border:2px solid #f0f0f0;border-radius:14px;padding:14px 16px;font-size:13px;color:#999;text-align:center;z-index:9999}
...
.pp-tier-row{display:flex;justify-content:space-between;align-items:center;padding:9px 14px;border-bottom:1px solid #f0f0f0;font-size:13px;color:#555;transition:background .15s}
...
.pp-result-label{font-size:11px;color:#E63946;font-weight:700;text-transform:uppercase;letter-spacing:.5px;margin-bottom:3px}
.pp-result-val{font-size:13px;color:#333;line-height:1.4}
.pp-result-row{display:flex;justify-content:space-between;align-items:center;padding:8px 15px;font-size:13px;color:#555;border-bottom:1px solid rgba(0,0,0,.04)}
...
.pp-fee-badge{background:#E63946;color:white;font-size:13px;font-weight:800;padding:4px 12px;border-radius:20px}
...
.pp-bname{font-size:13px;font-weight:800;color:#222;margin-bottom:3px}
.pp-baddr{font-size:12px;color:#555;line-height:1.4;margin-bottom:4px}
.pp-bmeta{font-size:11px;color:#888}
...
@media(max-width:480px){
  ...
  .pp-locate-btn{font-size:11px;padding:5px 10px}
}
`;