...
export default function CategoriesForm({ editedCategory, categoryName, setCategoryName, status, setStatus, errors, loadingForm, handleCategorySubmit, clearError, previewImage, setPreviewImage, pendingFile, setPendingFile, setEditedCategory,registerRef,STATUS_OPTIONS }) {
    return (
